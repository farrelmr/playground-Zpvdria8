...
@[Luke, how many stars are there in these galaxies?]({"stubs": ["src/main/java/com/javabullets/springboot/SpringbootApplication.java"], "command": "com.javabullets.springboot.SpringbootApplicationTests#myFirstSpringBootApplication"})
